...
subtitle: 'Subcellular glycan-mannose receptor binding kinetics correlate with myeloid cell function'
fontfamily: sans
output:
  pdf_document:
    toc: yes
...
# A set of functions to perform significance testing on derived parameters using ANOVA and Tukey HSD testing
...
# Here read in the data, using the root_directory you have previously defined
